...
5. In GitHub, the matching `rubygems.org` environment
   (Settings → Environments) is created automatically the first time the
   workflow runs. Add whatever reviewers/branch restrictions you want gating
   a publish.
